...
public class CompositionPass extends A_RenderPass {

    public CompositionPass(int id, String shaderPath) {
        super(id);
    ...
    public void render(HashMap<String, I_Image> inputs) {
        ...
        RenderBuffers.bindMainFrame();
        RenderBuffers.clearMainFrame();
        _SHADER.bind();
